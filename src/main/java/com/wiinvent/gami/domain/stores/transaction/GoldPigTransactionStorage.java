...
@Component
public class GoldPigTransactionStorage extends BaseStorage {
  public List<GoldPigTransaction> findAll(UUID userId, UUID transId, Long startDate, Long endDate, Long next, Long pre, int limit, CursorType type) {
    CriteriaBuilder criteriaBuilder = entityManager.getCriteriaBuilder();
    CriteriaQuery<GoldPigTransaction> query = criteriaBuilder.createQuery(GoldPigTransaction.class);
    Root<GoldPigTransaction> root = query.from(GoldPigTransaction.class);
    ...
    TypedQuery<GoldPigTransaction> typedQuery = entityManager.createQuery(query);
