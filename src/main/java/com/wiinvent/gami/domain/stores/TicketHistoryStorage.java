...
@Component
public class TicketHistoryStorage extends BaseStorage {
  public List<TicketHistory> findAll(UUID userId, UUID transId, Long startDate, Long endDate, Long next, Long pre, int limit, CursorType type) {
    CriteriaBuilder criteriaBuilder = entityManager.getCriteriaBuilder();
    CriteriaQuery<TicketHistory> query = criteriaBuilder.createQuery(TicketHistory.class);
    Root<TicketHistory> root = query.from(TicketHistory.class);
    ...
    TypedQuery<TicketHistory> typedQuery = entityManager.createQuery(query);
